...
namespace LearnXLua.LuaDemo.ReImplementInLua {
	...
	/// <summary>展示如何将复杂值类型改为lua实现。</summary>
	public class ReImplementInLua : MonoBehaviour {
		void Start() {
            ...
            xlua.setmetatable(CS.LearnXLua.LuaDemo.ReImplementInLua.PushAsTableStruct, mt)
            ...
            xlua.setclass(CS..LearnXLua.LuaDemo.ReImplementInLua, 'PushAsTableStruct', PushAsTableStruct)
        	");
            ...
            print(from_cs)
            CS.LearnXLua.LuaDemo.ReImplementInLua.PushAsTableStruct.Print(from_cs)
            from_cs:SwapXY()
            print(from_cs)

            print('--------------from lua---------------------')
            local from_lua = CS.LearnXLua.LuaDemo.ReImplementInLua.PushAsTableStruct(4, 5)
            assert(type(from_lua) == 'table')
            print(from_lua)
            CS.LearnXLua.LuaDemo.ReImplementInLua.PushAsTableStruct.Print(from_lua)
            from_lua:SwapXY()
            print(from_lua)
			");
